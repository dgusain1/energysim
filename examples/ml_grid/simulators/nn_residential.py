# -*- coding: utf-8 -*-
"""Neural-network residential load predictor — external simulator for energysim.

Loads pre-trained weights from residential_load_weights.npz and evaluates
...
class external_simulator(SimulatorAdapter):
    """Predicts residential load (MW) from time-of-day and weather features."""
    ...
    def __init__(self, inputs=None, outputs=None, **kwargs):
        ...
        w = np.load(Path(__file__).resolve().parent.parent / "residential_load_weights.npz")
